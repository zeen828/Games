	...
	<script>
			...
			function DrawMap(){
					...
					for(var j = 0;j<map[i].length;j++){
						...
						case "."://Path
							...
							if(j== goal_array[0]&& i == goal_array[1]){//(2,1)のgoalの描画
								...
								ctx.closePath();
							}else if(j== goal_array[18]&& i == goal_array[19]){
								ctx.beginPath();
								ctx.fillStyle = "#FF801E";
								ctx.fillRect(w*goal_array[18],w*goal_array[19],w,h);
								var lw = 3;
								ctx.fillStyle = "#E16200";
								ctx.fillRect(w*goal_array[18] + lw,w*goal_array[19] + lw ,w - lw -3,h -lw -3);
								ctx.closePath();
							}else if(j== goal_array[20]&& i == goal_array[21]){
								ctx.beginPath();
								ctx.fillStyle = "#FF801E";
								ctx.fillRect(w*goal_array[20],w*goal_array[21],w,h);
								var lw = 3;
								ctx.fillStyle = "#E16200";
								ctx.fillRect(w*goal_array[20] + lw,w*goal_array[21] + lw ,w - lw -3,h -lw -3);
								ctx.closePath();
							}else if(j== goal_array[22]&& i == goal_array[23]){
								ctx.beginPath();
								ctx.fillStyle = "#FF801E";
								ctx.fillRect(w*goal_array[22],w*goal_array[23],w,h);
								var lw = 3;
								ctx.fillStyle = "#E16200";
								ctx.fillRect(w*goal_array[22] + lw,w*goal_array[23] + lw ,w - lw -3,h -lw -3);
								ctx.closePath();
							}else{//pathの描画
								ctx.beginPath();
								ctx.fillStyle = "#B8F2A5";
				...
				if(
						...
						map[goal_array[19]][goal_array[18]] == "b" &&
						map[goal_array[21]][goal_array[20]] == "b" &&
						map[goal_array[23]][goal_array[22]] == "b"
				){
